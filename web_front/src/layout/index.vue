        ...
        <div id="app-main">
            ...
            <div class="wrapper">
                ...
                <div class="main-container" :style="{'padding-bottom': $route.meta.paddingBottom}">
                    <Topbar v-if="!((settingsStore.menu.menuMode === 'head' || settingsStore.menu.menuMode === 'userHead') && !settingsStore.topbar.enableSidebarCollapse && !settingsStore.topbar.enableBreadcrumb)" />
                    <div class="main">
