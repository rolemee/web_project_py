...
const emit = defineEmits(['update:url', 'on-success', 'on-request'])
...
<template>
    <div class="upload-container">
        <el-upload
            ...
            class="image-upload"
        >
            <el-image v-if="url === ''" :src="url === '' ? placeholder : url" :style="`width:${width}px;height:${height}px;`" fit="cover">
                <template #error>
            ...
            <div v-else class="image">
                <el-image :src="url" :style="`width:${width}px;height:${height}px;`" fit="cover" />
                <div class="mask">
                    <div class="actions">
