...
num = 1
for i in json_data:
    # print(i['questionTitle'])
    # print(''.join(lazy_pinyin(i['questionTitle'])))
    # print(''.join(lazy_pinyin(i['questionTitle'],style=Style.FIRST_LETTER)))
...
client.index('web_project').update_searchable_attributes(['title','title_pinyin','title_pinyin_space','title_pinyin_firstLetter'])  