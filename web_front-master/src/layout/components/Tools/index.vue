...
onMounted(() => console.log(userStore.permissions[0]))
</script>
...
<template>
    <div class="tools">
        ...
        <el-dropdown class="user-container" size="default" @command="userCommand">
            ...
            <template #dropdown>
                <el-dropdown-menu v-if="userStore.permissions[0] === 1" class="user-dropdown">
                    <el-dropdown-item v-if="settingsStore.dashboard.enable" command="dashboard">控制台</el-dropdown-item>
                    <el-dropdown-item command="setting">个人设置</el-dropdown-item>
                    <el-dropdown-item divided command="logout">退出登录</el-dropdown-item>
                </el-dropdown-menu>
                <el-dropdown-menu v-if="userStore.permissions[0] === 0" class="user-dropdown">
                    <el-dropdown-item v-if="settingsStore.dashboard.enable" command="myQuestion">我的提问</el-dropdown-item>
