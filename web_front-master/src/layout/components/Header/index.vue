...
<template>
    <transition name="header">
                ...
                <div class="main">
                    ...
                    <div class="nav">
                        <template v-for="(item, index) in menuStore.allMenus">
                            <div v-if="item.children && item.children.length !== 0" :key="index" class="item" :style="index === menuStore.actived ? 'background-color: #1890ff;color: #fff': '' " :class="{'active': index === menuStore.actived}" @click="switchMenu(index)">
                                <el-icon>
        ...
        <header v-else-if="settingsStore.mode === 'pc' && settingsStore.menu.menuMode === 'userHead'" style="box-shadow: var(--el-box-shadow-light)">
            <div class="header-container">
